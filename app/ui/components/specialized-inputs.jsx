...
export const EmailInput = forwardRef((props, ref) => (
  <FormInput ref={ref} type="email" icon="email" placeholder="ejemplo@correo.com" {...props} />
));
...
export const PhoneInput = forwardRef((props, ref) => (
  <FormInput ref={ref} type="tel" icon="phone" placeholder="(555) 123-4567" {...props} />
));
...
export const DateInput = forwardRef((props, ref) => (
  <FormInput ref={ref} type="date" icon="date" {...props} />
));
...
export const TextareaInput = forwardRef(
  ({ maxLength, showCount = false, rows = 4, ...props }, ref) => {
